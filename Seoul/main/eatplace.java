// ORM class for table 'eatplace'
// WARNING: This class is AUTO-GENERATED. Modify at your own risk.
//
// Debug information:
// Generated date: Tue Feb 14 14:38:12 KST 2023
...
public class eatplace extends SqoopRecord  implements DBWritable, Writable {
  ...
  public eatplace with_no(Integer no) {
    this.no = no;
    return this;
  }
  private String name;
  ...
  public eatplace with_name(String name) {
    this.name = name;
    return this;
  }
  ...
  public eatplace with_address(String address) {
    this.address = address;
    return this;
  }
  ...
  public eatplace with_review_star(String review_star) {
    this.review_star = review_star;
    return this;
  }
  ...
  public eatplace with_review_text(String review_text) {
    this.review_text = review_text;
    return this;
  }
  private String gu;
  ...
  public eatplace with_gu(String gu) {
    this.gu = gu;
    return this;
  }
  public boolean equals(Object o) {
    ...
    if (!(o instanceof eatplace)) {
      return false;
    }
    eatplace that = (eatplace) o;
    boolean equal = true;
  ...
  public void readFields(ResultSet __dbResults) throws SQLException {
    ...
    this.no = JdbcWritableBridge.readInteger(1, __dbResults);
    this.name = JdbcWritableBridge.readString(2, __dbResults);
    this.address = JdbcWritableBridge.readString(3, __dbResults);
    this.review_star = JdbcWritableBridge.readString(4, __dbResults);
    this.review_text = JdbcWritableBridge.readString(5, __dbResults);
    this.gu = JdbcWritableBridge.readString(6, __dbResults);
  }
  ...
  public int write(PreparedStatement __dbStmt, int __off) throws SQLException {
    JdbcWritableBridge.writeInteger(no, 1 + __off, 4, __dbStmt);
    JdbcWritableBridge.writeString(name, 2 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(address, 3 + __off, 12, __dbStmt);
    JdbcWritableBridge.writeString(review_star, 4 + __off, -1, __dbStmt);
    JdbcWritableBridge.writeString(review_text, 5 + __off, -1, __dbStmt);
    JdbcWritableBridge.writeString(gu, 6 + __off, 12, __dbStmt);
    return 6;
  }
...
this.readFields0(__dataIn);  }
  ...
  public Object clone() throws CloneNotSupportedException {
    eatplace o = (eatplace) super.clone();
    return o;
  }

  public void clone0(eatplace o) throws CloneNotSupportedException {
  }
