...
for i in range(len(location)) : 
    ...
    area_name = xmlObject['SeoulRtd.citydata']['CITYDATA']['AREA_NM']
    area_time = xmlObject['SeoulRtd.citydata']['CITYDATA']['LIVE_PPLTN_STTS']['LIVE_PPLTN_STTS']['PPLTN_TIME']
    area_min = xmlObject['SeoulRtd.citydata']['CITYDATA']['LIVE_PPLTN_STTS']['LIVE_PPLTN_STTS']['AREA_PPLTN_MIN']
    area_max = xmlObject['SeoulRtd.citydata']['CITYDATA']['LIVE_PPLTN_STTS']['LIVE_PPLTN_STTS']['AREA_PPLTN_MAX']
    
    area_total = area_name + ","+ area_time + ","+ area_min + "," + area_max
     
    
    open_logfile = open('/home/bit/Seoul/log/logfile4.log', 'a', encoding='utf-8')
    open_logfile.write('\n'+ area_total)
